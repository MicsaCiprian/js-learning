...
console.log("The main practical difference is that we can actually call function declarations before they are defined in the code.");
console.log("The function expressions we cannot call before they are defined.");
/* Example 1. Function Declaration. */
function calcAge(birthYear) { // Function parameter.
...
console.log("An arrow function is basically a function expression that is shorter and faster to write.");
...
console.log("[Introduction to Arrays] Two most important data structures in javascript: Arrays and Objects. ");
...
console.log(`[Second method] Using Array function to create an array: ${years}`);

/* Extract elements from array. */
console.log(`[Extracting elements by index] Extracting first element from list by index ${friends} -> ${friends[0]}`);
...
const differentDataTypes = [13, 'Michael', true, false, '31', 2017 - 33, [2, 3, 4], friends];
...
const ages = [calcAge5(years1[0]), calcAge5(years1[1]), calcAge5(years[years.length - 1])];
console.log(ages);
...
console.log("[Push Method] Append an item to the array and return the lenght of the array.");
...
console.log("[Unshift Method] Insert an element to the beggining of the array and returns the new lenght of the array.");
...
console.log("[Pop Method] Opposite to push method. Removes the last element from the array and returns it.");
console.log(`[Pop Method] Before removing: ${friends2}`);
friends2.pop();
console.log(`[Pop Method] After removing: ${friends2}`);

/* Remove the first element from the array. */
console.log("[Shift Method] Syntax: array.shift(). If array is empty, returns undefined.");
console.log("[Shift Method] Opposite to unshift method. Removes the first element from the array and returns it.");
...
console.log("[indexOf Method] Syntax: array.indexOf('string_to_search', *optional* starting_position). Returns position of element. If element not present, returns -1.");
console.log(`[indexOf Method] Searching for Steven in the array. Found at position ${friends2.indexOf('Steven')} in the array: ${friends2}`);
console.log(`[indexOf Method] An index from which the method starts can be specified. Found at position ${friends2.indexOf('Peter', 1)} in the array: ${friends2}`);

/* Find an element in array. Returns true if found, false if not. */
console.log("[includes Method] Syntax: array.includes('searched_element', *optional* start_index)");
console.log("[includes Method] Search for an element in array. Returns true if found, false is not. Very important: This method does === comparison (no type coercion).");
console.log(`[includes Method] Searching for Steven in the array (${friends}). Found it: ${friends.includes('Steven')}`);
console.log(`[includes Method] Searching for peter in the array (${friends}). You can also specify position. Found it: ${friends.includes('peter', 1)}`);
...
console.log("In Objects, we define key-value pairs. An object is defined using the {} brackets. An array is defined using [] brackets.");
...
console.log("Getting a property from an object (jonas.lastName): ", jonas.lastName);
console.log("Getting a property from an object using brackets (jonas['lastName']): ", jonas['lastName']);
console.log("The big difference is that in the bracket [] notation, we can put any expression we like (jonas['first' + nameKey]).");
const nameKey = 'Name';
...
console.log("We get undefined when we are trying to access a property of an object that does not exist. Instead of dot notation, use expression.");
...
console.log("################### Add new properties to the object. ###################");
console.log("You can add properties in two ways: jonas.location = 'Romania' or jonas['youtubeUser'] = 'Utii'");
...
const jonas1 = {
    ...
    getSummary: function() {
        return `${this.firstName} is a ${this.calcAge()}-year old ${this.job}, and he has ${this.hasDriverLicense ? 'a': 'no'} driver's licence.`;
    }
};
...
console.log('If the string is the same, it will not be printed x times. Instead, a small counter icon will appear in the Console Log.');
for (let rep = 1; rep <= 10; rep++) {
...
console.log("[Continue] Example. We printed only string types, ignoring the other ones using 'continue'.");
...
console.log('[Break] Example. We will stop the loop when a number is found in the array.');

for (let i = 0; i < jonasArray.length; i++) {
    if (typeof(jonasArray[i]) === 'number') break;
    console.log(`Iteration #${i}: Element: ${jonasArray[i]}, type: ${typeof[jonasArray[i]]}`);
}
...
console.log("[While Loop] Another example of a while loop - rolling dice until hit 6.");
