...
console.log(`You are ${ageCip} years old and Nicole is ${ageNicole} years old.`);
console.log(`Cip's age divided: ${ageCip / 2} and Cip's age multiplied: ${ageCip * 2}`);
...
console.log(`You can do smarter calculations directly: ${currentYear - 1996 > currentYear - 2000}`);
...
const fullDescription = 'I\'m ' + firstName1 + ', a ' + (currentYear2 - birthYear) + ' years old ' + job + '!';
console.log(fullDescription);

/* Template literals. */
const fullDescription2 = `I'm ${firstName1}, a ${currentYear2 - birthYear} years old ${job}!`;
...
console.log("#################### Strings and Template Literals END ####################");
...
console.log("#################### IF / Else Statements END ####################");
console.log("#################### Type Conversion and Coercion ####################");
// Type conversion is when we manually convert from one type to another.
// Type coercion is when JavaScript automaticallly converts types behind the scenes.
console.log("Javascript can convert to a number, to a string or to a boolean. It cannot convert to underfined or to null.")

const inputYear = '1991';
console.log(`If we want to add a number string type to int, we could use Number() to cast it.`);
...
console.log(`Converting a number 'Cip 'which isn't a number and we get: ${Number('Cip')}, which stands for Not-A-Number.`);
...
switch(day) {
    ...
    case 'wednesday':
    case 'thursday':
        console.log("You can have two cases and execute the same condition for them");
...
const drink = age2 >= 18 ? "You are allowed to drink wine" : "You are underaged. You can drink water";
